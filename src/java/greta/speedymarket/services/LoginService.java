...
public class LoginService {
    ...
    public void authenticate() {
        System.out.println("*********************** le "+new SimpleDateFormat("dd.MM.yyy").format(new Date())+" a "+new
        SimpleDateFormat("HH:mm:ss").format(new Date())+" : Tentative d'authentification d'un admin ");
        ...
        if(loginBean.getLogin().compareTo("admin")==0 && loginBean.getPassword().compareTo("adminadmin")==0) {
            ...
            System.out.println("*********************** le "+new SimpleDateFormat("dd.MM.yyy").format(new Date())+" a"+new SimpleDateFormat("HH:mm:ss").format(new Date())+" : Authentification admin success");
